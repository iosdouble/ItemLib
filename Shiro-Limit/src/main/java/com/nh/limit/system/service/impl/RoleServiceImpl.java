...
import com.nh.limit.common.utils.SortUtil;
import com.nh.limit.system.entity.Role;
import com.nh.limit.system.entity.RoleMenu;
import com.nh.limit.system.mapper.RoleMapper;
import com.nh.limit.system.service.IRoleMenuService;
...
public class RoleServiceImpl extends ServiceImpl<RoleMapper, Role> implements IRoleService {
    ...
    private void saveRoleMenus(Role role) {
        if (StringUtils.isNoneBlank(role.getMenuIds())){
